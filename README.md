...
**Level:** Intermediate+  
**Goal:** Create, complete, filter, and permanently save tasks.  
**Coding ideas:** Forms, localStorage, JSON, filters
...
2. Open the folder named `05-homework-tracker`.
...
1. Create a new public GitHub repository named `05-homework-tracker`.
...
`https://YOUR-USERNAME.github.io/05-homework-tracker/`
